...
# АВТОМАТИЧЕСКАЯ НАСТРОЙКА CORS ДЛЯ БЕЗОПАСНОСТИ ТЕЛЕФОНОВ
@app.after_request
...
# МАСШТАБНАЯ МНОГОУРОВНЕВАЯ СИСТЕКА КВЕСТОВ
MULTILEVEL_QUESTS = {
    "djinn_1": {
